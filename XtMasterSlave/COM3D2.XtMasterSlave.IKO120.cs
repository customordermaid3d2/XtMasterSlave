...
namespace XtMasterSlave_IK_XDLL
{
    ...
    public class IkpInst : IkInst
    {
        ...
        {
            var ikP = m.body0.IKCtrl.GetIKData(hand, IKBend).GetTargetData(IKCtrlData.IKAttachType.Point);
        ...
        public override void CopyHandIK(Maid master, Maid slave, XtMasterSlave.v3Offsets[] v3ofs, int num_)
        {
            ...
            listHand.ToList().ForEach(h =>
            {
                ...
                listTypes.ForEach(t =>
                {
                    var ikm = ikcm.GetTargetData(t);
                    var iks = ikcs.GetTargetData(t);
                    ...
                    if (!(string.IsNullOrEmpty(ikm.Tgt_AttachName) && ikm.Target == null))
                    {
                        ...
                        if (IkXT.IsIkCtrlO117)
                        {
                            ikcs.SetIKSetting(t, false, ikm.TgtChara, ikm.Tgt_AttachSlot, ikm.Tgt_AttachName, ikm.AxisTgt, ikm.Target, ikm.TgtOffset, ikm.DoAnimation);
        ...
        public override bool GetIKCmoPosRot(TBody body, out Vector3 pos, out Quaternion rot, string hand = "右手")
        {
            ...
            var data = ctrl.GetTargetData(IKCtrlData.IKAttachType.Point);
            if (data.Target != null)
            {
